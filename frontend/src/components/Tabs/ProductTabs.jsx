...
const handleTabClick = (e,tab)=>{e.preventDefault(); setActiveTab(tab)}
    return (   
    <div className="single-tabs">
                <ul className="tab-list">
                    <li>
                        <a href="#" className={`tab-button ${activeTab==="Description"&&"active"}`} onClick={(e)=>handleTabClick(e,"Description")}>Description</a>
                    </li>
                    <li>
                        <a href="#" className={`tab-button ${activeTab==="Information"&&"active"}`} onClick={(e)=>handleTabClick(e,"Information")}>
                ...
                <div className="tab-panel">
                    <div className={`tab-panel-descriptions content ${activeTab==="Description"&&"active"}`} id="desc">
                    ...
                    <div className={`tab-panel-information content ${activeTab==="Information"&&"active"}`} id="info">
                    ...
                    <Reviews activeTab={`${activeTab==="Reviews"?"content active":"content"}`}/>
