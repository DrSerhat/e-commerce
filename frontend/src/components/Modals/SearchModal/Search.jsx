...
const Search = ({isSearchVisible,setIsSearchVisible}) => {
  return (
    <div className={`modal-search ${isSearchVisible?"show":""}`}>
    ...
    <div className="modal-wrapper">
      ...
      <i className="bi bi-x-circle" id="close-search" onClick={()=>{setIsSearchVisible(false)}}></i>
    </div>
    <div className="modal-overlay" onClick={()=>{setIsSearchVisible(false)}}></div>
  </div>
    );
};
